...
image1 = Image.open("../razer/onedrive/desktop/chocol/pj.jpg")  # Asegúrate de que la ruta sea correcta
new_img = image1.resize((100, 100))
new_img.save("pj2.jpg")
photo1 = ImageTk.PhotoImage(new_img)
image2 = Image.open("../razer/onedrive/desktop/chocol/chocol1.jpg")  # Asegúrate de que la ruta sea correcta
